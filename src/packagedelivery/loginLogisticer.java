 ...
 * @author aimab
 */
public class loginLogisticer extends javax.swing.JFrame {

    /**
     * Creates new form loginLogisticer
     */
    public loginLogisticer() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Logisticer login");
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/packagedelivery/icons/logisticer.jpg"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(txtusername.getText().equals("") || txtPassword.getText().equals("")){
            ...
            LogisticerOgi l = new LogisticerOgi();
            l.setVisible(true);
            this.setVisible(false);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(loginLogisticer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new loginLogisticer().setVisible(true);
            }
        });
    }
